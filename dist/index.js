...
function axiosSimpleRetry(axios, _a) {
    ...
    axios.interceptors.response.use(function (res) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!canRetry(currentRetry, retries, retryStatus, error)) return [3 /*break*/, 2];
                    currentRetry++;
                    delay_1 = incrementalDelay ? retryDelay * currentRetry : retryDelay;
                    return [4 /*yield*/, new Promise(function (ms) { return setTimeout(ms, delay_1); })];
                case 1:
                    _a.sent();
